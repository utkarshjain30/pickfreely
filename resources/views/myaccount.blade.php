            ...
            <form class="form" action="{{URL::current()}}/update" method="post" id="registrationForm">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <div class="col-xs-6">
                        ...
                        <input type="text" class="form-control" name="zipcode" id="zipcode" placeholder="ZIPCODE" title="enter your zipcode." value="{{$zipcode}}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        ...
                        <input type="state" class="form-control" name="state" id="state" placeholder="State" title="enter your state." value="{{$state}}">
                    </div>
                </div>
                <div class="form-group">
